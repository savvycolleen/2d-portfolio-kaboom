...
export const dialogueData = {
  ...
  "degrees": `Oh, look! My degrees! I have my bachelor's in elementary education, and my master's in literacy. While seemingly irrelevant to coding, many of my passions began here. Also, niche obsessions like brain states and metacognition, but I digress. Here is a <a href="https://docs.google.com/presentation/d/19RCg0LBKIoSMufgiN86zl8ZvHyJ4pzU-M0DmyP_ZXDg/edit?usp=sharing" target="_blank">lecture on MVC</a> to prove that I can tie my worlds together. It may or may not be Harry Potter style.`,
  ...
  tv: `That's my TV. I won't lie. I love binging a good series. From Friends to Downtown Abbey to the Sopranos, I love it all. My most recent watches are Shogun, The 3 Body Problem, and Below Deck: Mediterranean. Variety is important, right? 😅 Tell me what you are watching! I'm not kidding. I want to know.`,
  bed: `Before bed is often my brain's favorite time to obsessively plot what projects I should start next or deep dive into a new obsession. Anyone else?`,
  ...
  library: `I have been an avid read since I was a child, but I am not an obsessive book-buyer (thank you, public libraries!).
  Thanks to my English minor, I do have some British Literature on my shelves, and lots of kid's books for my toddler. In recent years, I have been really into fantasy! Have we read any of the <a href="https://www.goodreads.com/user/show/91040164-savannah-colleen" target="_blank">same books</a>? Let's dish!`,
